  ...
  async execute(interaction) {
    ...
    if (agency == "606339196160049153" || agency == "249389362813468673") {
      ...
      await interaction.reply(
        `Bounty on <@!${killed_score["user_id"]}> has been collected by <@!${killer_score["user_id"]}>. <@!${killer_score["user_id"]}>, you now have ${killer_score["score"]} points. You might be the next bounty. Watch your back.`
      );
    } else {
